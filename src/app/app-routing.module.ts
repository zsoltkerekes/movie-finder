...
const routes: Routes = [
  ...
  },
  {
    path: 'tv-details',
    loadChildren:
      './shared-modules/tv-details/tv-details.module#TvDetailsModule',
    data: {
      pageTitle: `${baseTitle}`,
    },
  },
  {
    path: 'person-details',
    loadChildren:
      './shared-modules/person-details/person-details.module#PersonDetailsModule',
    data: {
      pageTitle: `${baseTitle}`,
    },
  },
  {
    ...
    loadChildren:
      './shared-modules/tv-show-episodes/tv-show-episodes.module#TvShowEpisodesModule',
    data: {
      pageTitle: `${baseTitle}`,
    },
  },
  {
    path: 'now-playing',
    loadChildren:
      './shared-modules/now-playing/now-playing.module#NowPlayingModule',
    data: {
      pageTitle: `${baseTitle}`,
    },
  },
  ...
  },
  {
    path: '404',
    loadChildren:
      './shared-modules/page-not-found/page-not-found.module#PageNotFoundModule',
    data: {
      pageTitle: `${baseTitle}`,
    },
  },
